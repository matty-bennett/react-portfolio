        ...
        <div className="about fluid">
            <Container className="d-flex justify-content-center fluid">
                <Row className="align-items-baseline">
                    ...
                    <Col className="intro">
                        <h1 className="about-title" style={{fontWeight: "bolder"}}>Hello There!</h1>
